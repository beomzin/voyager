<template>
    <label>이름 : </label>
    <input type="text" v-model="result.name" placeholder="이름"/>
    <br>
    <label>나이 : </label>
    <input type="text" v-model="result.age" placeholder="나이"/>
    <br/>
    <label>성별 : </label>
    <label>남성</label>
    ...
    <br/>
    <label>시간 : </label>
    <input type="time" v-model="result.time" />
    <br/>
    <label>색깔 : </label>
    <input type="color" v-model="result.color" />
    <br/>
    <label>범위 : </label>
...
<script>
    ...
    export default {
        setup() {
            ...
            const country_options = ['한국', '미국', '영국', '일본']
            const date = ''
            const time = ''
            const color = '#ffffff'
            const range = 1
